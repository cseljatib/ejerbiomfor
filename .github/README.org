* Sitio con material complementario libro de /Biometría y Modelación Forestal/
...
[[https://github.com/cseljatib/labPackages][web]], para vuestra descarga. Esto se debe a que la frecuencia con la cual se puede actualizar un paquete en [[https://r-project.or][el sitio web de R]] es generalmente menor a la cual nosotros realizamos cambios.
